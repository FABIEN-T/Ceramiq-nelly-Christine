  ...
  return (
    <>
      ...
      <main>
        ...
        <article>
          <p>
            Nelly  Martinelli est venue à la céramique après un parcours de vie
            dans l’animation sociale. En plus des techniques classiques, elle
            utilise la méthode du papier porcelaine, mélange de porcelaine et de
            cellulose, qui permet d’obtenir des pièces d’une extrême finesse.
            Elle exposait au Salon Habitat & vie d’Épinal. Après la fermeture du
            centre social où elle travaillait, elle a beaucoup voyagé. « J’ai
            visité 41 pays, fait de la plongée sous-marine, confie-t-elle. C’est
            sûrement de là que m’est venu cette fascination pour les
            coraux ».  Elle découvre sur les Salons, l’artisanat d’art une
            expression à travers différents matériaux. Elle « flashe » sur la
            terre à Auboué, où se déroulent les Aubouesielles, qui met en scène
            5 artistes, 5 matériaux sur 5 jours.
          </p>
        </article>
        <article>
          <h3>La céramique par le feu</h3>
          <p>
            « J’ai été attirée par la céramique, explique-t-elle, je ne sais pas
            dire pourquoi. Sûrement à cause du raku, ce système de cuisson par
            le feu où l’objet se transforme sur les différentes étapes sans
            qu’on puisse vraiment savoir ce qui va en sortir ». La métamorphose
            par le feu … « Le feu, symbole de vie, de chaleur humaine, de
            convivialité ». Avec la cuisson raku, le résultat est toujours une
            surprise, une découverte. On ne voit ce que donne sa pièce qu’une
            fois nettoyée. C’est presque magique !
          </p>
        </article>
        <article>
        ...
        <article>
          ...
          <p>
            Mais elle a gardé une partie animation et fait de la céramique avec
            les écoles et les centres de loisirs. C’est sa plongée dans le
            monde. Pas question de rester sans contacts, et pour ça, les Salons,
            c’est le Must !
          </p>
        </article>
      </main>
